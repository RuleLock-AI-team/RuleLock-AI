"""
RuleLock AI — Automated Enforcement Engine: actions
Owner: Mishen

Each function simulates the real-world action it names. In a full
production system these would call payment/logistics APIs; here they
return what the action WOULD do, which is enough to prove the decision
logic and demo the flow end-to-end.
